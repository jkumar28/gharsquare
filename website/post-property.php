                ...
                <section class="post-step-panel" data-step-panel="profile">
                    <form class="post-step-form" data-step-form="profile">
                        ...
                        <div class="post-form-grid">
                            ...
                            <label class="post-check" data-profile-field data-visible-for="residential" data-pg-hide-field><input type="checkbox" name="study_room"<?= checkedAttr($profile['study_room'] ?? 0) ?>> Study room</label>
                        </div>
